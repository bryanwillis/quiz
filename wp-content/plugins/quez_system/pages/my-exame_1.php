...
//                    $table_quiz_authentication = $wpdb->prefix . "quiz_authentication";
        ...
        <script>
//            window.location.replace ("https://globalcoach.ststagingserver.com/assessment/?request=yes");
        </script>
        <?php
//                    echo do_shortcode('[wp_paypal_payment]');
            }
		...
		<div class="request_exam">
            ...
            <ul>
				<li><a class="request_button" href="?request=yes&question=1&">Complete the ICBI</a></li>
                <li>  </li>
                <li>
...
necessarily reflect all individual experiences. 
             ...
             <ul>   
				 <li>
					...
					<a class="bext_button" style="width:200px;color: white; text-decoration:none;" href="../register/" onclick="location.href='../register';"  >Register</a>
